...
const ecosystemItems = [
  ...
  },
  {
    ...
    image: "/luxury-perfume-bottles-cosmetics-lifestyle-premium.jpg",
  },
  {
    icon: Home,
    title: "Real Estate",
    description: "Acquiring income-generating properties.",
    image: "/luxury-modern-real-estate-building-property-invest.jpg",
  },
  {
    icon: Smartphone,
    title: "Mobile Applications",
    description: "Launching utility-based and lifestyle apps.",
    image: "/mobile-application-development-smartphone-ui-desig.jpg",
  },
  {
    icon: BookOpen,
    title: "Education",
    description: "Investing in private educational ventures.",
    image: "/online-education-learning-platform-university-camp.jpg",
  },
  {
    icon: TrendingUp,
    title: "Trading Firms",
    description: "Establishing trading capital funds for steady income.",
    image: "/stock-market-trading-financial-charts-cryptocurren.jpg",
  },
]
